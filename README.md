...
**Phases 0–2 complete; Phase 3 in progress** — the ingestion + retrieval spine, the extraction + red-flag engine, the agentic Q&A path, and the API surface the web app needs are built and tested. The web UI is what remains of Phase 3. See [PRD.md](PRD.md) for the full specification and roadmap.
