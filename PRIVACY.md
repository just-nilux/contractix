...
> Status: Phase 0/1 draft. This document tracks FR-7 commitments as they are implemented; it is
...
| Document text is data, never instructions (prompt-injection posture)                   | enforced by design from Phase 3; injection suite in CI Phase 4 |
...
| LLM (Phase 2+) | Anthropic                 | `claude-sonnet-5`, `claude-haiku-4-5` | EU data-processing terms to be confirmed & documented before first production call       |
